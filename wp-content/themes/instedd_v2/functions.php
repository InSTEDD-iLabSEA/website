		...
		<div class="image-slider">
			<div class="slider">
				...
				<div class="slide-numbers">
					<a href="#" class="active slider-number">1</a>
					<a href="#" class="slider-number">2</a>
					<a href="#" class="slider-number">3</a>
				</div>
			</div>
		</div>
	<?php endif;
	...
	query_posts('showposts=-1&cat=10');
		if (have_posts()): $loopID = 0; ?>
			<div class="featured-posts-slider">
				<div class="featured-posts-slides">
					<?php while(have_posts()): the_post(); $loopID++; ?>
						<div class="featured-post" <?php echo ($loopID == 1) ? 'style="display: block;"' : ''; ?>>
							<a href="<?php the_permalink(); ?>">
								<?php $featured_image = get_meta('_post_featured_image'); ?>
								<img src="<?php echo ecf_get_image_url($featured_image); ?>" alt="" />
								<span>
