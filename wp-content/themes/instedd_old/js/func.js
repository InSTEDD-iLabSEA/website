...
jQuery(function($) {
	...
	*/
	...
	function slider_initCallback1 (carousel) {
		$(".image-slider .btn-next").click(function () {
			carousel.stopAuto();
			carousel.next();
			return false;
		});
	...
	function slider_initCallback2 (carousel) {
		$(".box-slider .btn-prev").click(function () {
			carousel.stopAuto();
			carousel.prev();
			return false;
		});
		
		$(".box-slider .btn-next").click(function () {
			carousel.stopAuto();
			carousel.next();
			return false;
		});
	...
	function slider_initCallback3 (carousel) {
		$(".ess .thumbs .btn-prev").click(function () {
			carousel.stopAuto();
			carousel.prev();
			return false;
		});
		
		$(".ess .thumbs .btn-next").click(function () {
			carousel.stopAuto();
			carousel.next();
			return false;
		});
		
		$(".ess .thumbs .btn-pause").live('click', function () {
			carousel.startAuto(0);
			$(this).removeClass('btn-pause').addClass('btn-play');
			return false;
		});
		
		$(".ess .thumbs .btn-play").live('click', function () {
			carousel.startAuto(5);
			$(this).removeClass('btn-play').addClass('btn-pause');
			return false;
		});
		
		$(".ess .thumbs .slider a").click(function () {
