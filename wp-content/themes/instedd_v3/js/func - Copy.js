...
*/
  ...
  $('.button').each(function(){
	...
	Cufon.replace('.network-category-nav a, #navigation ul li a, #windowBox, .image-slider .info h2, .image-slider .info p, .image-slider .btn-next, .box-slider .slider .box h3, .feed .head h2, .feed .head h3, .widgets h2, #footer .widget_nav_menu > div > ul > li > a, #footer .col h4, .contacts label, .cont	acts h4, #sidebar ul li .widgettitle, #sidebar ul li.widget ul li a, .content h2, .press .item h3, .sidebar-r ul li .widgettitle, .sidebar-r .btn-donate, .sidebar-r .btn-tell, .box-updates label, .sidebar-r ul li.nav ul li, .sidebar-r2 .widgettitle, .hor-bar h3, .ess .descr h3, .ess .descr h4, .ess .descr h5, .subpage h3, .not-singular-post h4, #header a.btn-donate-big, #header a.btn-contact, span.button, #header a.contact, #header a.enews, #header input.search, #home-boxes-container h2, #home-boxes-container h3, div.nivo-caption p a', { fontFamily : 'Aller', hover : true });
