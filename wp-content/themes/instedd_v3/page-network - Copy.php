		...
		<?php while (have_posts()) : the_post(); ?>
			<div id="main" class="inner">
				...
				<div class="content video left">
					...
					<h1>Network</h1>
					<?php $all_categories = sort_categories(get_terms(array('Network Type'))); ?>
					...
					<div style="clear:both;">&nbsp;</div>
						...
						?>
						<?php foreach ($all_categories as $c): ?>
							<h2><a name="<?php echo $c->slug; ?>"></a><?php echo $c->name; ?></h2>
				...
				<div class="network-item"><a href="<? echo $network_link; ?>"><h3><?php echo $v->post_title; ?></h3></a>
				<?php if ( $network_link ) {?>
					<a href="<? echo $network_link; ?>"><img src="<?php echo ecf_get_image_url($network_image); ?>" alt="" align="left" style="margin:5px;"  /></a>
				<?php } elseif ( $network_image ) {?>
					<img src="<?php echo ecf_get_image_url($network_image); ?>" alt="" align="left" style="margin:5px;"  />
				<?php } ?>
				<?php echo apply_filters('the_content', $v->post_content); ?> </div>
				<div class="cl">&nbsp;</div>
