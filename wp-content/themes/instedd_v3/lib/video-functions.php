...
*/
function create_embedcode($video_url, $width = 565, $height = 450) {
	...
	return '<object width="' . $width . '" height="' . $height . '"><param name="movie" value="' . $actual_file . '&showinfo=0"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><param name="wmode" value="transparent"><embed src="' . $actual_file . '&showinfo=0" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="' . $width . '" height="' . $height . '" wmode="transparent"></embed></object>';
}

function get_youtube_thumbnail($video_url) { 
    preg_match('~\/watch\?v=([^?&]*)~', $video_url, $matches); 
